    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonChangePass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Call<JsonObject> changePasswordCall = RetrofitClient.getInstance().getMyApi().changePassword(student.getStudentEmail(),editTextPass.getText().toString(),editTextConfirmPass.getText().toString());
